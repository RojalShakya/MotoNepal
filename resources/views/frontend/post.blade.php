				...
				<div class="col-lg-9">
					<div class="post_content">
						...
						<div class="post_panel post_panel_top d-flex flex-row align-items-center justify-content-start">
							<div class="author_image"><div><img src={{url('frontend/images/author.jpg')}} alt=""></div></div>
						...
						<div class="post_body">
							...
							<figure>
								<img src={{url('frontend/images/post_image.jpg')}} alt="">
						...
						<div class="similar_posts">
							<div class="grid clearfix">
								...
								<div class="card card_small_with_image grid-item">
									<img class="card-img-top" src={{url('frontend/images/post_25.jpg')}} alt="https://unsplash.com/@jakobowens1">
									<div class="card-body">
								...
								<!-- Small Card With Image -->
								<div class="card card_small_with_image grid-item">
									<img class="card-img-top" src={{url('frontend/images/post_26.jpg')}} alt="https://unsplash.com/@jakobowens1">
									<div class="card-body">
										<div class="card-title card-title-small"><a href="post.html">How Did van Gogh’s Turbulent Mind Depict One of the Most Complex Concepts in Physics?</a></div>
										<small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>
									</div>
										...
										<div class="comments_container">
											<ul class="comment_list">
												...
												<li class="comment">
													<div class="comment_body">
														<div class="comment_panel d-flex flex-row align-items-center justify-content-start">
															<div class="comment_author_image"><div><img src={{url('frontend/images/comment_author_1.jpg')}} alt=""></div></div>
															<small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>
															<button type="button" class="reply_button ml-auto">Reply</button>
														</div>
														<div class="comment_content">
