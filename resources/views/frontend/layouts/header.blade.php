        ...
        <div class="row">
            <div class="col">
                <div class="header_content d-flex flex-row align-items-center justify-content-start">
                    <div class="logo"><a href="#">Motor N Gears</a></div>
                    <nav class="main_nav">
                        <ul>
                    ...
                    <div class="search_container ml-auto">
                        <div class="weather">
                            ...
                            <img class="weather_icon" src={{url('frontend/images/cloud.png')}} alt="">
                        </div>
                        <form action="#">
                            <input type="search" class="header_search_input" required="required" placeholder="Type to Search...">
                            <img class="header_search_icon" src={{url('frontend/images/search.png')}} alt="">
                        </form>
